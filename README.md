...
<p>I spend most of my time in web development using PHP and Javascript, but I also have some experience in desktop and mobile applications using Python and Java. I'm now focusing on adding C#, .NET Core, and Angular to my stack.</p>
