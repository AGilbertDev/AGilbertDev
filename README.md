...
<p>Most of my time is spent in web development using PHP and Javascript, but I also have some experience in desktop and mobile applications using Python and Java.</p>
